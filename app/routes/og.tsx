...
export default function OpenGraphImage() {
  return (
    <main className="relative h-[675px] w-[1200px] overflow-hidden bg-background-pattern">
      <div className="m-[5%] flex h-[80%] w-[80%] -rotate-1 flex-col rounded-2xl border border-solid border-white/50 bg-white/50 px-8 py-6 drop-shadow-xl backdrop-blur-lg backdrop-saturate-150">
        ...
        <h1 className="mb-4 flex h-full max-w-40 grow items-center align-middle text-8xl font-bold">
          Rulos Artísticos
        </h1>
